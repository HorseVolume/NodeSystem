...
////// Lighting:
                ...
                float3 finalColor = lerp(_rendertarget_var.rgb,lerp(node_2044,(node_2044*_innercirclecolor.rgb),_colorbubbleclip_var.r),clamp((_scaledivide/objScale.r),0,1));
